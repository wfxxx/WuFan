...
//    @OperationAspect(value = "系统管理--新增系统基本信息")
    @RequestMapping(value = "/addDSGCSystemEntities", method = RequestMethod.POST)
    public Response addDSGCSystemEntities(@RequestBody DSGCSystemEntities systemEntities) {
        this.dsgcSystemService.addDSGCSystemEntities(systemEntities);
        return Response.ok();
    }

//    @OperationAspect(value = "系统管理--新增或修改系统基本信息")
    @RequestMapping(value = "/modifyDSGCSystemEntities", method = RequestMethod.POST)
    public Response modifyDSGCSystemEntities(@RequestBody DSGCSystemEntities systemEntities) {
//        System.out.println(systemEntities);
        try{
            if(systemEntities.getId() != null && !"".equals( systemEntities.getId() )){
                this.dsgcSystemService.updateDSGCSystemEntities(systemEntities);
            }else {
                this.dsgcSystemService.addDSGCSystemEntities(systemEntities);
            }
        }catch (Exception ex) {
            logger.error("%s", ex.getMessage());
            return Response.error("保存信息失败！").setMessage(ex.getMessage());
        }
    ...
    @RequestMapping(value = "/updateDSGCSystemEntities", method = RequestMethod.POST)
    public Response updateDSGCSystemEntities(@RequestBody DSGCSystemEntities systemEntities) {
        this.dsgcSystemService.updateDSGCSystemEntities(systemEntities);
        return Response.ok();
    }
