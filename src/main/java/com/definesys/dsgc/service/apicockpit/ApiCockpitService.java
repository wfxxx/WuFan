...
public class ApiCockpitService {
    ...
    public  Map<String,Object> queryTrafficAnalysis (String appId){
        ...
        result.put("flowRunTime",apiCockpitDao.queryMonthRuntimes(appId));
        result.put("flowsucessTime",apiCockpitDao.queryMonthSucess(appId));
        result.put("flowConsumer",apiCockpitDao.queryMonthConsumer(appId));
        return result;
    }
