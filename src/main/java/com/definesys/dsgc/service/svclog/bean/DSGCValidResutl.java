...
public class DSGCValidResutl extends MpaasBasePojo implements Serializable {
...
//    @SequenceGenerator(name="demo_emp_seq1", sequenceName="DEMO_SEQ1")
    ...
    public DSGCValidResutl (){
        super();
    }

    public DSGCValidResutl(String servNo, String systemCode, String validType, String validColumn, String validValue, String attribue1, String attribue2, String attribue3, String attribue4, String attribue5, Integer versionNumber, String createdBy, Date creationDate, String lastUpdatedBy, Date lastUpdateDate) {
        this.servNo = servNo;
