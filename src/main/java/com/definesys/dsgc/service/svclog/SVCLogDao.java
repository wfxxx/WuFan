...
//            }
    ...
    public PageQueryResult<DSGCValidResult> querySvcLogResultByCon(SVCLogQueryBean q, int pageSize, int pageIndex, String userRole, List<String> sysCodeList){
        StringBuffer sqlStr;
        MpaasQuery mq = sw.buildQuery();
        sqlStr = new StringBuffer("select distinct dvr.serv_no,dvr.system_code,dvr.valid_type,dvr.valid_column," +
                "dvr.valid_value,dvr.warning_value,dvr.msg_value,dvr.last_update_date,dsu.user_name lastUpdatedBy,ds.serv_name attribue1,dse.sys_name attribue2,dse1.sys_name attribue3 " +
...
//        }
        ...
        return mq.doPageQuery(pageIndex,pageSize, DSGCValidResult.class);
    }
    ...
    public void deleteResultObj(DSGCValidResult validResut){
    ...
    public void addResultObj(DSGCValidResult validResult){
        System.out.println(validResult.toString());
        sw.buildQuery().doInsert(validResult);
    }
