package com.definesys.dsgc.service.ystar.excel.bean;
...
public class SvcPayloadParam extends MpaasBasePojo implements Serializable {
    ...
    public SvcPayloadParam() {
    }

    public SvcPayloadParam(String resCode) {
        this.resCode = resCode;
    }

    public SvcPayloadParam(String resCode, String reqOrRes) {
        this.resCode = resCode;
