...
public class MarketController {
    ...
    private Response getMarketEsb(@RequestBody Map<String,Object> mapValue,
                                  @RequestParam(value = "pageSize", required = false, defaultValue = "12") int pageSize,
                                  @RequestParam(value = "pageIndex", required = false, defaultValue = "1") int pageIndex){
        Map<String,Object> mapValue1=new HashMap<String,Object>();
        //搜索框查询的条件
    ...
    private Response getPowerType(@RequestBody Map<String,Object> mapValue){
        String userId=null;
    ...
    private Response getClassType( @RequestParam(value = "sourceType") String sourceType){
        List<Map<String,Object>> reslut= this.marketService.getClassType(sourceType);
        if(reslut==null){
