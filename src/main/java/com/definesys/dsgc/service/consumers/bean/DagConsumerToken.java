...
@Table(value = "dag_consumer_token")
public class DagConsumerToken  extends MpaasBasePojo implements Serializable {
    @RowID(type = RowIDType.UUID)
    private String dctId;
    private String dcjId;
    ...
    public String getDcjId() {
        return dcjId;
    }

    public void setDcjId(String dcjId) {
        this.dcjId = dcjId;
    }
