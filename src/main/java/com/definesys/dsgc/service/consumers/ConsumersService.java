...
//            dagConsumerJwt.setEnvCode(param.getEnvCode());
//            String key = secretKey + dsgcConsumerEntities.getCsmCode();
...
//            dagConsumerToken.setCsmCode(dsgcConsumerEntities.getCsmCode());
//            dagConsumerToken.setEnvCode(param.getEnvCode());
